...
from guizero import App, TextBox, Text, PushButton, ListBox, Combo, Box, Textbox
...
class_combo = Combo(app, options=["GRA","BIO","PHY","MAT","DTC","ART","ENG","XYZ"], selected="black", command=count_class)
