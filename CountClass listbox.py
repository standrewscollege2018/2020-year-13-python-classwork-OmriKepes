...
from guizero import App, TextBox, Text, PushButton, ListBox, Combo
...
class_listbox = ListBox(app, items=["GRA","BIO","PHY","MAT","DTC","ART","ENG","XYZ"], selected="black", command=count_class)
# Start the program
app.display()